...
/*#include "include/Utilities.h"
#include "include/MarchingTets.h"
...
public:
    ...
    TetraMesh(string path, float res = 1.0f): _res(res) {
        int *res_tetra = LoadPLY_Tet(path + string("TetraShell-0.2-200.ply"), &_Nodes, &_Faces, &_Tetra);
    ...
    inline float *LevelSet(float **volume_weights, float *vertices, float *skin_weights, int *faces, float *normals_face, int nb_faces) {
        *volume_weights = new float[24*_Nb_Nodes];
        ...
        //return TetLevelSet_sphere(make_my_float3(0.2f,1.0f,-0.5f), 0.15f, _Nodes, _Nb_Nodes);
        //return TetLevelSet_sphere(make_my_float3(0.0f,0.0f,0.5f), 0.15f, _Nodes, _Nb_Nodes);
    }
    ...
    void ComputeAdjacencies(string savedir, int *rates, int adjnodes) {
        ...
        list2csv(savedir + "/adjlist_4to3-200.csv", adjlist4);
        ...
        list2csv(savedir + "/adjlist_3to2-200.csv", adjlist3);
        ...
        list2csv(savedir + "/adjlist_2to1-200.csv", adjlist2);
        ...
        list2csv(savedir + "/adjlist_1to0-200.csv", adjlist1);
