...
from external.poseAware.models.skeleton import SkeletonUnpool, SkeletonPool, SkeletonConv, find_neighbor, SkeletonLinear
import sys
...
class Encoder(nn.Module):
    def __init__(self, args, topology):
        ...
        """
        print("self.topologies:",self.topologies)
        print("len(self.topologies):",len(self.topologies[0]))
        print("self.edge_num:", self.edge_num)
        """
        ...
        #print("self.channel_base:",self.channel_base)
        #print("args.skeleton_dist:",args.skeleton_dist)
