...
class SkeletonConv(nn.Module):
    def __init__(self, neighbour_list, in_channels, out_channels, kernel_size, joint_num, stride=1, padding=0,
        ...
        #print("neighbor_list:" ,neighbour_list)
        ...
        #print("expanded_neighbour_list:",self.expanded_neighbour_list)
...
class SkeletonLinear(nn.Module):
    ...
    def forward(self, input):
        ...
        weight_masked = self.weight * self.mask
        #print("debug_input.shape:",input.shape)
        #print("debug_weight_masked.shape:",weight_masked.shape)
